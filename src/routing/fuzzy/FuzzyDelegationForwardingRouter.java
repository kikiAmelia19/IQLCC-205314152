...
/**
 * <p>
 * This is a routing algorithm based on fuzzy logic with two input variable,
 * this scheme using contact duration and inter-contact duration for input
 * variable. Based on the probability density function to arrange the membership
 * function using JFuzzyLogic for the fuzzy engine. This routing protocol
 * provide efficiency in routing performance. Improved with delegation
 * forwarding scheme.
 * </p>
 *
